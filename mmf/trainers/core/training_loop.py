...
# Last Change:  2024-04-30 05:52:59
import gc
import logging
from abc import ABC
...
from mmf.utils.general import clip_gradients, extract_loss, get_max_updates, convert_weights_fp16
...
class TrainerTrainingLoopMixin(ABC):
    ...
    def training_loop(self) -> None:
        ...
        #self.after_training_loop()  # FIXME: debug evaluation code
    ...
    def _finish_update(self):
        ...
        #self.optimizer.step()
        #self.optimizer.zero_grad()
        #convert_weights_fp16(self.model)
