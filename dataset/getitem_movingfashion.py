...
# Last Change:  2023-09-18 03:22:53
...
class MF_TrainDataLoader(Dataset):
    """MovingFashion train dataset loader."""
    def __init__(
            self,
            data_path,
            tokenizer,
...
class MF_DataLoader(MF_TrainDataLoader):
    """MF dataset loader."""
    def __init__(
            self,
            data_path,
            ...
            frame_order=0,
            slice_framepos=0):
        super(MF_DataLoader, self).__init__(
            data_path,
            tokenizer,
            max_words=30,
            feature_framerate=1.0,
